...
const projects = [
  ...
  { id: 9, title: 'Compony Profile Naposo HKBP Pondok Kelapa', description: 'HTML, CSS, & JavaScript', foto: naposoImage, sourceCode: '#', source: 'https://rnhkbppondokkelapa.vercel.app/' },
];
